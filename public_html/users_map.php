...
function getUsersMap()
{
    ...
    for ($i = 0; $i < $nRows; $i++) {
        ...
        $markers .= '                var infowindow' . $marker['mkid'] . ' = new google.maps.InfoWindow({' . LB
            . '                  content: ' . MAPS_jsString($presentation) . LB
            . '                });' . LB;

        // Adding a click-event to the marker
        $markers .= '                google.maps.event.addListener(marker' . $marker['mkid'] . ', \'click\', function() {' . LB
            . '                    infowindow' . $marker['mkid'] . '.open(map0,marker' . $marker['mkid'] . ');' . LB
            . '                });' . LB;
