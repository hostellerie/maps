...
$LANG_confignames['maps']['google_server_api_key'] = 'Google Geocoding server API key';
...
$LANG_confignames['maps']['users_map_lat'] = 'Users map center latitude (blank = automatic)';
$LANG_confignames['maps']['users_map_lng'] = 'Users map center longitude (blank = automatic)';
$LANG_confignames['maps']['users_map_zoom'] = 'Users map zoom (blank = global map)';
$LANG_confignames['maps']['users_map_type'] = 'Users map type (blank = global map)';
$LANG_confignames['maps']['users_map_width'] = 'Users map width (blank = global map)';
$LANG_confignames['maps']['users_map_height'] = 'Users map height (blank = global map)';
...
$LANG_MAPS_1['server_geocode_key_missing'] = 'Server-side coordinate lookup is enabled, but no dedicated Google Geocoding server API key is configured. The browser key is never used for server-side geocoding.';
$LANG_MAPS_1['api_diag_title'] = 'Google Maps Platform configuration';
...
$LANG_MAPS_1['api_diag_browser_key'] = 'Browser API key';
$LANG_MAPS_1['api_diag_server_key'] = 'Server API key';
$LANG_MAPS_1['api_diag_map_id'] = 'Map ID';
$LANG_MAPS_1['api_diag_configured'] = 'Key configured — API not verified';
$LANG_MAPS_1['api_diag_browser_verify'] = 'Key configured — verify with the browser test below';
$LANG_MAPS_1['api_diag_referrer_hint'] = 'For browser-key HTTP referrer restrictions, authorize this site (for example: %s/*).';
$LANG_MAPS_1['api_diag_missing'] = 'Missing';
$LANG_MAPS_1['api_diag_optional'] = 'Optional / not configured';
$LANG_MAPS_1['integrations_title'] = 'Integrations';
$LANG_MAPS_1['integrations_intro'] = 'Maps uses Geeklog APIs and services so related plugins can discover Maps without direct database coupling.';
$LANG_MAPS_1['integration_active'] = 'Active';
$LANG_MAPS_1['integration_missing'] = 'Plugin missing';
$LANG_MAPS_1['integration_native'] = 'Native support';
...
$LANG_MAPS_1['use_my_location'] = 'Use my location';
$LANG_MAPS_1['geolocation_unavailable'] = 'Browser geolocation is unavailable. Enter a starting address manually.';
$LANG_MAPS_1['geolocation_denied'] = 'Your position could not be obtained. Allow location access or enter a starting address manually.';
$LANG_MAPS_1['geolocation_https'] = 'Browser geolocation normally requires HTTPS.';
?>
